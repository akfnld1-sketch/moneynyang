...
function renderBudgetPage() {
  ...
  <div style="background:var(--surface);border:1.5px solid rgba(79,124,255,.3);border-radius:12px;
              padding:14px 16px;margin-bottom:12px;">
    <div style="font-size:13px;font-weight:700;color:var(--accent);margin-bottom:10px;">🎯 월 저축 목표</div>
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:8px;">
      <!-- 적금 -->
      <div style="background:rgba(79,124,255,.07);border:1px solid rgba(79,124,255,.2);border-radius:9px;padding:10px 12px;">
        <div style="font-size:11px;color:var(--accent);font-weight:700;margin-bottom:6px;">🏦 적금</div>
        <div style="font-size:10px;color:var(--text3);margin-bottom:6px;line-height:1.5;">매월 꾸준히<br>모으는 금액</div>
      ...
      <!-- 비상금저축 -->
      <div style="background:rgba(61,214,140,.07);border:1px solid rgba(61,214,140,.2);border-radius:9px;padding:10px 12px;">
        <div style="font-size:11px;color:var(--green);font-weight:700;margin-bottom:6px;">🛡️ 비상금저축</div>
        <div style="font-size:10px;color:var(--text3);margin-bottom:6px;line-height:1.5;">생활비 바닥날 때<br>쓸 예비 금액</div>
        <div style="display:flex;align-items:center;gap:4px;">
    ...
    <div style="margin-top:6px;padding:7px 10px;background:rgba(61,214,140,.07);border-radius:7px;
      ...
      🛡️ 비상금 ${(budgetState.emergencyFund||0).toLocaleString()}원 확보 목표 — 잔고 소진 위험 시 생존관리 알람에 반영돼요
    </div>`:''}
  </div>`
